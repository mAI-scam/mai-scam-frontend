        ...
        {products.map((product) => (
          ...
          >
            <div className="relative">
              <div className="aspect-square bg-gray-100 flex items-center justify-center text-4xl md:text-6xl">
                {product.image}
              </div>
              <Badge className="absolute top-1 md:top-2 left-1 md:left-2 bg-red-500 text-white text-xs">
                -{product.discount}
              </Badge>
              <Badge className="absolute top-1 md:top-2 right-1 md:right-2 bg-orange-500 text-white text-xs">
                {product.tag}
              </Badge>
            </div>

            <CardContent className="p-2 md:p-3">
              <h3 className="text-xs md:text-sm font-medium line-clamp-2 mb-1 md:mb-2">
                {product.name}
              </h3>
              ...
              <div className="flex items-center gap-1 mb-1 md:mb-2">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className="h-2 w-2 md:h-3 md:w-3 fill-yellow-400 text-yellow-400"
                  />
                ))}
              ...
              <div className="mb-1 md:mb-2">
                <div className="text-orange-500 font-bold text-sm md:text-lg">
                  {product.salePrice}
                </div>
