...
const fakeReviews = [
  {
    name: "Ahmad B.",
    rating: 5,
    comment: "Terbaik! Barang original dan murah gila!",
  },
  { name: "Siti N.", rating: 5, comment: "Fast delivery! Sangat puas hati 😍" },
  {
    name: "John L.",
    rating: 5,
    comment: "Best deal ever! Highly recommended!",
  },
  {
    name: "Farah M.",
    rating: 5,
    comment: "Alhamdulillah, produk sampai dengan selamat",
  },
...
export function SocialProofSection() {
  ...
  return (
    <div className="bg-gray-50 py-4 md:py-8" data-tour="social-proof">
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 md:space-y-3">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 md:p-4 animate-pulse">
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-sm text-gray-600">
                      {livePurchases[currentPurchase].product} •{" "}
                      {livePurchases[currentPurchase].location}
                    </p>
                    <p className="text-xs text-gray-500">
                      {livePurchases[currentPurchase].time}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <Card key={index} className="opacity-70">
                  <CardContent className="p-2 md:p-3">
                    <p className="text-xs md:text-sm">
                      <span className="font-medium">{purchase.user}</span>{" "}
                      membeli {purchase.product}
                    </p>
                    <p className="text-xs text-gray-500">
                      {purchase.location} • {purchase.time}
                    </p>
                  </CardContent>
                </Card>
              ))}
