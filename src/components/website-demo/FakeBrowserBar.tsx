...
import { Lock, ChevronLeft, ChevronRight, RotateCw, Home, Star } from 'lucide-react';

interface FakeBrowserBarProps {
  websiteUrl?: string;
}

export function FakeBrowserBar({ websiteUrl = 'deal-raya-123.com' }: FakeBrowserBarProps) {
  return (
