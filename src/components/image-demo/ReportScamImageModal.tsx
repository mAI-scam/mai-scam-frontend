...
export function ReportScamImageModal({
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/60 z-[9997] flex items-center justify-center p-4">
      <Card className="max-w-2xl w-full max-h-[90vh] overflow-y-auto" data-tour="report-modal">
        ...
        <CardContent className="space-y-6">
          {!isSuccess ? (
            <>
              {/* Reporting Services */}
              <div data-tour="reporting-services">
              ...
              <div className="flex gap-3 pt-4 border-t">
                ...
                <Button
                  ...
                  data-tour="submit-report-button"
                >
                  {isSubmitting ? (
                    <>
            ...
            /* Success State */
            <div className="text-center py-8" data-tour="report-success">
              ...
              <Button onClick={handleClose} className="w-full" data-tour="close-report-button">
                {t.close}
              </Button>
            </div>
          )}
