...
> = {
  ...
  lo: {
    ...
    lowPrices:
      "ພົບລາຄາຕໍ່າຜິດປົກກະຕິສໍາລັບສິນຄ້າຍີ່ຫໍ້ (iPhone RM999, PS5 RM599) — ກลະທົບທີ່ມັກໃຊ້ເພື່ອລໍ້ລວງເຫຍື່ອ.",
    suspiciousUrl:
  ...
  my: {
    ...
    whyDangerous: "ဘာကြောင့် ဤဝဘ်ဆိုက် 危险?",
    lowPrices:
    ...
    suspiciousUrl:
      'ဝဘ်ဆိုက် URL "deal-raya-123.com" သည် သံသယဖွယ် ဖြစ်ပြီး Shopee/Lazada ကဲ့သို့的平台များကို ကွတ်ကွတ်ကွင်းကွင်း လိုက်မှီပါသည်။',
    urgency:
      "“လက်လျှော့ဈေး”၊ “စတော့ကပ်” စသည့် စိတ်ပညာကျောက်တံတားများဖြင့် ယခု ချက်ချင်း ဝယ်ယူရန် အလွန် ဖိအားပေးထားသည်။",
    fakeReviews:
  ...
  ta: {
    ...
    lowPrices:
      "பிராண்டட் பொருட்களுக்கு இயலாத அளவு குறைந்த விலை (iPhone RM999, PS5 RM599) கண்டறியப்பட்டது. இது மோசடிகள் பொதுவாக பயன்படுத்தும் உந்துதல்.",
    suspiciousUrl:
