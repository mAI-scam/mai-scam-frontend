        ...
        <section className="text-center mb-8 md:mb-12">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-6">
              Complete guide for installing and using the mAIscam browser
              extension to protect against scams
            </p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-amber-700">
                          <strong>Important:</strong> Your first scam detection
                          may take 15-30 seconds as our AI services boot up from
                          AWS Lambda cold start. This is normal! Subsequent
                          detections will be much faster (typically 2-5 seconds)
                          as the services remain active.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                        <p className="text-sm text-blue-800">
                          <strong>💡 For Judges:</strong> Click the link above
                          to access the GitHub releases page where you can
                    ...
                    <div className="space-y-6">
                      <ol className="space-y-3 text-gray-700">
                        ...
                        <li className="flex items-start gap-2">
                          <ArrowRight className="w-4 h-4 text-green-600 mt-1 flex-shrink-0" />
                          <span>
                            Right-click and select &ldquo;Extract All&rdquo; or
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-6">
                      <p className="text-gray-700">
                        <strong>
                          Open Google Chrome and navigate to the extensions
                          management page:
                        </strong>
                      </p>
                      <p className="text-sm text-gray-600 mb-3">
                        <strong>Click</strong> the URL below to{" "}
                        <strong>copy</strong> it, then <strong>paste</strong> it
                        into a <strong>new Chrome tab</strong>:
                      </p>
                ...
                <Card className="border-2 border-yellow-200">
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-6">
                      <p className="text-gray-700">
                        On the extensions page, you&apos;ll find a
                        &ldquo;Developer mode&rdquo; toggle in the top-right
                        corner.
                      </p>
                      ...
                      <ol className="space-y-3 text-gray-700">
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            <strong>
                              Look for the &ldquo;Developer mode&rdquo; toggle
                              switch
                            </strong>
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <ArrowRight className="w-4 h-4 text-yellow-600 mt-1 flex-shrink-0" />
                          <span>
                            <strong>Click to enable it</strong> (the toggle
                        ...
                        <li className="flex items-start gap-2">
                          <ArrowRight className="w-4 h-4 text-yellow-600 mt-1 flex-shrink-0" />
                          <span>
                            <strong>New buttons will appear:</strong>{" "}
                            &ldquo;Load unpacked&rdquo;, &ldquo;Pack
                            extension&rdquo;, &ldquo;Update&rdquo;
                          </span>
                        </li>
                      </ol>
                    ...
                    <div className="space-y-6">
                      ...
                      <ol className="space-y-3 text-gray-700">
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            <strong>
                              Click the &ldquo;Load unpacked&rdquo; button
                            </strong>
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                        ...
                        <li className="flex items-start gap-2">
                          <ArrowRight className="w-4 h-4 text-red-600 mt-1 flex-shrink-0" />
                          <span>
                            <strong>Click &ldquo;Select Folder&rdquo;</strong>
                          </span>
                        </li>
                      </ol>
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                        ...
                        <p className="text-xs text-green-700 mt-2">
                          The mAIscam extension now appears in your extensions
                          list and Chrome toolbar, and is ready to use!
                        </p>
                      </div>
                    </div>
                  </CardContent>
                    ...
                    <div className="space-y-6">
                      ...
                      <ol className="space-y-4 text-gray-700">
                        ...
                        <li className="flex items-start gap-2">
                          <ArrowRight className="w-4 h-4 text-green-600 mt-1 flex-shrink-0" />
                          <span>
                            The extension popup will open, showing available
                            options
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <ArrowRight className="w-4 h-4 text-green-600 mt-1 flex-shrink-0" />
                          <span>
                            Choose the appropriate analysis option based on what
                            you want to scan
                          </span>
                        </li>
                      </ol>
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                        ...
                        <p className="text-xs text-green-700">
                          Click on the mAIscam icon in the Chrome toolbar to
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <p className="text-xs text-blue-700">
                          The extension will show a loading state while
                      ...
                      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                        ...
                        <div className="space-y-2 text-xs text-amber-700">
                          <div className="flex items-center gap-2">
                            ...
                            <span>
                              <strong>First detection:</strong> 15-30 seconds
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span>
                              <strong>Subsequent detections:</strong> 2-5
                              seconds (services active)
                            </span>
                          </div>
                        </div>
                        <p className="text-xs text-amber-700 mt-2 italic">
                          💡 This is normal behavior for serverless
                          applications. Please be patient during your first
                          detection!
                        </p>
                      </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-red-700 font-semibold mb-2">
                              <strong>
                                ⛔ DO NOT SWITCH TABS while detection is
                                running!
                              </strong>
                            </p>
                            <p className="text-sm text-red-700">
                              When the extension shows &ldquo;loading&rdquo; or
                              is analyzing content,{" "}
                              <strong>stay on the current tab</strong> until the
                              analysis is complete. Switching tabs may interrupt
                              the detection process and cause it to fail.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-red-100 border border-red-300 rounded-lg p-4">
                      ...
                      <p className="text-red-700 mb-4 font-medium">
                        <strong>Easiest solution:</strong> Restart the extension
                      ...
                      <div className="bg-white border border-red-200 rounded-lg p-4">
                        ...
                        <ol className="space-y-2 text-red-700">
                          <li className="flex items-start gap-2">
                            <span className="bg-red-600 text-white text-sm rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 mt-0.5">
                              1
                            </span>
                            <span>
                              Go to{" "}
                          ...
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              Toggle the extension <strong>OFF</strong> then{" "}
                              <strong>ON</strong>
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                      ...
                      <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-3 mt-4">
                        <p className="text-sm text-yellow-800">
                          💡 <strong>Note:</strong> This restart process fixes
                          95% of extension issues and takes less than 30
                          seconds.
                        </p>
                      </div>
                    </div>
            ...
            <section className="mb-8 md:mb-12 max-w-4xl mx-auto">
              <div className="bg-gradient-to-r from-blue-50 to-green-50 border-2 border-blue-300 rounded-xl p-8 text-center">
                ...
                <p className="text-lg text-gray-700 mb-6">
                  Your mAIscam extension is now successfully installed and ready
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-lg p-6 mb-6 border border-blue-200">
                  ...
                  <p className="text-blue-700 mb-4">
                    Click the <strong>&ldquo;How to Use mAIscam&rdquo;</strong>{" "}
                    tab above to learn how to:
                  </p>
            ...
            <section className="mb-8 md:mb-12 max-w-6xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200 rounded-xl p-6 mb-8">
                ...
                <p className="text-center text-gray-600 mb-6">
                  Quick navigation to see how mAIscam works with different
                  content types
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      const websiteSection =
                        document.getElementById("website-protection");
                  ...
                  <Button
                    ...
                    onClick={() => {
                      const socialSection = document.getElementById(
              ...
              <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      <div className="space-y-4">
                        ...
                        <ol className="text-base space-y-3 text-gray-700">
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              <strong>Click the extension icon</strong> in your
                              Chrome toolbar (puzzle piece icon if hidden)
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="bg-gray-600 text-white text-sm rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 mt-0.5">
                            ...
                            <span>
                              <strong>Find and click the mAIscam icon</strong>{" "}
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-red-700 mb-3 font-medium">
                                <strong>Easiest fix:</strong> Restart the
                                extension and refresh your browser
                              </p>
                              <div className="bg-white border border-red-200 rounded-lg p-3">
                                <h5 className="font-semibold text-red-800 mb-2">
                                  How to restart the extension:
                                </h5>
                      ...
                      <div className="bg-blue-100 rounded-lg p-4">
                        ...
                        <p className="text-blue-700 mb-3">
                          Once loaded, the extension will show you different
                          analysis options based on the type of content you want
                          to scan.
                        </p>
                        <div className="bg-white rounded overflow-hidden shadow-md">
                          <Image
                ...
                >
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-6">
                      <p className="text-gray-700">
                        Protect yourself from email scams and phishing attempts
                        with our AI-powered email analysis.
                      </p>
                      ...
                      <div className="bg-gray-100 rounded-lg p-4">
                        ...
                        <p className="text-gray-700 mb-3">
                          Open any email in Gmail. The mAIscam extension will
                          add an &ldquo;<strong>Analyze Email</strong>&rdquo;
                          button to help you detect potential scams.
                        </p>
                        <div className="bg-white rounded overflow-hidden shadow-md">
                          <Image
                      ...
                      <div className="bg-blue-50 rounded-lg p-4">
                        ...
                        <p className="text-blue-700 mb-3">
                          After clicking analyze, our AI provides a detailed
                          report with a risk assessment and actionable
                          recommendations.
                        </p>
                        <div className="bg-white rounded overflow-hidden shadow-md">
                          <Image
                      ...
                      <div className="bg-green-50 rounded-lg p-4">
                        ...
                        <p className="text-green-700 mb-3">
                          Get comprehensive analysis with risk level,
                          recommended actions, and the option to proceed with
                          caution or blur suspicious content.
                        </p>
                        <div className="bg-white rounded overflow-hidden shadow-md">
                          <Image
                      ...
                      <div className="bg-red-50 rounded-lg p-4">
                        ...
                        <p className="text-red-700 mb-3">
                          For flagged emails, choose to blur the content to
                          protect yourself from potentially harmful content
                          while still being able to review it if needed.
                        </p>
                        <div className="bg-white rounded overflow-hidden shadow-md">
                          <Image
                ...
                >
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-6">
                      <p className="text-gray-700">
                        Detect scam posts and suspicious content on social media
                        platforms with AI-powered analysis.
                      </p>
                      ...
                      <div className="bg-gray-100 rounded-lg p-4">
                        ...
                        <p className="text-gray-700 mb-3">
                          Browse your social media feed normally. When you
                          encounter suspicious content, click the mAIscam
                          extension and select &ldquo;Scan Post&rdquo;.
                        </p>
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-blue-700">
                                <strong>
                                  Make sure the post you want to analyze is
                                  currently visible on your screen
                                </strong>{" "}
                                before clicking the scan button. The extension
                                analyzes what&apos;s currently displayed in your
                                browser window.
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="bg-blue-50 rounded-lg p-4">
                        ...
                        <p className="text-blue-700 mb-3">
                          Select the specific post or content you want to
                          analyze. The extension supports both Facebook and
                      ...
                      <div className="bg-green-50 rounded-lg p-4">
                        ...
                        <p className="text-green-700 mb-3">
                          Get detailed analysis of the post content, including
                          risk assessment and recommended actions based on
                      ...
                      <div className="bg-red-50 rounded-lg p-4">
                        ...
                        <p className="text-red-700 mb-3">
                          Similar to email protection, flagged social media
                          content can be blurred to protect you from potentially
                          harmful posts while still allowing review.
                        </p>
                        <div className="bg-white rounded overflow-hidden shadow-md">
                          <Image
                      ...
                      <div className="bg-blue-100 rounded-lg p-4">
                        ...
                        <p className="text-blue-700 mb-4">
                          We support both Facebook and Twitter. Here&apos;s an
                          example of Twitter content analysis:
                        </p>
                        <div className="space-y-6">
                          <div className="bg-white rounded overflow-hidden shadow-md">
                ...
                >
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-6">
                      <p className="text-gray-700">
                        Analyze websites for potential scams, phishing attempts,
                        and malicious content before you interact with them.
                      </p>
                      ...
                      <div className="bg-gray-100 rounded-lg p-4">
                        ...
                        <p className="text-gray-700 mb-3">
                          Navigate to any website. Click the mAIscam extension
                          and select &ldquo;<strong>Analyze Website</strong>
                          &rdquo; to scan the current page for potential
                          threats.
                        </p>
                        <div className="bg-white rounded overflow-hidden shadow-md">
                          <Image
                      ...
                      <div className="bg-blue-50 rounded-lg p-4">
                        ...
                        <p className="text-blue-700 mb-3">
                          Receive comprehensive analysis of the website
                          including domain reputation, content analysis, and
                          security assessment.
                        </p>
                        <div className="bg-white rounded overflow-hidden shadow-md">
                          <Image
                      ...
                      <div className="bg-green-50 rounded-lg p-4">
                        ...
                        <p className="text-green-700 mb-3">
                          Get detailed results with risk assessment, recommended
                          actions, and the option to proceed with caution. Note:
                          Website analysis doesn&apos;t include blur
                          functionality.
                        </p>
                        <div className="bg-white rounded overflow-hidden shadow-md">
                          <Image
                      ...
                      <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                        ...
                        <p className="text-orange-700 mb-3">
                          <strong>For Your Safety:</strong> Test the website
                          scam detection with our safe, simulated phishing
                          website:
                        </p>
                        ...
                        <div className="bg-red-100 border border-red-300 rounded-lg p-3">
                          ...
                          <p className="text-xs text-red-700">
                            This is a controlled, harmless simulation.{" "}
