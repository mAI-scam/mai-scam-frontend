              ...
              <CardContent className="space-y-4 md:space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-white border border-red-200 rounded-lg p-3 text-center">
                    <div className="text-xl md:text-2xl font-bold text-red-600 mb-1">82%</div>
                    <p className="text-xs md:text-sm text-red-800">Cybercrime surge (2021-2022)</p>
                  </div>
                  <div className="bg-white border border-red-200 rounded-lg p-3 text-center">
                    <div className="text-xl md:text-2xl font-bold text-red-600 mb-1">63%</div>
                    <p className="text-xs md:text-sm text-red-800">Social media penetration</p>
                  </div>
                  <div className="bg-white border border-red-200 rounded-lg p-3 text-center">
                    <div className="text-xl md:text-2xl font-bold text-red-600 mb-1">246K</div>
                    <p className="text-xs md:text-sm text-red-800">
                      <a href="https://controld.com/blog/phishing-statistics-industry-trends/" target="_blank" rel="noopener noreferrer" className="underline hover:text-red-900">
                ...
                <div className="space-y-3">
                  <h4 className="font-bold text-red-800 text-sm md:text-base">Three Critical Challenges:</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-red-700 text-xs md:text-sm">
                        Criminal syndicates weaponize Southeast Asia&apos;s linguistic diversity, targeting victims in native languages with culturally-tailored attacks that generic tools cannot detect.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-red-700 text-xs md:text-sm">
                        Scammers exploit massive social media penetration through platforms like Facebook for fraudulent offers, fake job postings, and travel deals targeting vulnerable populations.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-red-700 text-xs md:text-sm">
                        With <a href="https://controld.com/blog/phishing-statistics-industry-trends/" target="_blank" rel="noopener noreferrer" className="underline hover:text-red-900">over 12 million blocked links in six months</a> and 36% of data breaches involving phishing, current defenses are completely overwhelmed.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-red-100 border border-red-300 rounded-lg p-3">
                  ...
                  <ul className="space-y-2 text-xs md:text-sm text-red-700">
                    <li className="flex items-start space-x-2">
                      ...
                      <span><strong>Passive & Reactive:</strong> Tools like Singapore&apos;s CheckMate require manual input, offering protection that&apos;s often too late.</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span><strong>Siloed & Context-Blind:</strong> Solutions like Whoscall lack cultural intelligence needed for localized threats across web, social media, and email.</span>
                    </li>
                  </ul>
                </div>
              </CardContent>
          ...
          <section className="mb-8 md:mb-12 max-w-5xl mx-auto">
            <div className="bg-blue-100 border-2 border-blue-400 rounded-xl p-6 md:p-8 text-center shadow-xl">
              ...
              <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
                An <strong className="text-[#EB6700]">AI-powered, culturally intelligent</strong> web extension 
                that provides <strong className="text-[#49A4EF]">real-time protection</strong> against scams across 
                emails, websites, and social media platforms — specifically designed for Southeast Asia&apos;s 
